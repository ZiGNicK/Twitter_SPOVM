...
public class MainActivity extends AppCompatActivity  {
    ...
    public void getInfo(){
        ...
        setIvUserProfileBGImg((ImageView) findViewById(R.id.ivUserProfileBGImg));
        Picasso.with(getApplicationContext()).load(profileImgBgUrl).into(getIvUserProfileBGImg());

    }

    public ImageView getIvUserProfileBGImg() {
        return ivUserProfileBGImg;
    }

    public void setIvUserProfileBGImg(ImageView ivUserProfileBGImg) {
        this.ivUserProfileBGImg = ivUserProfileBGImg;
    }
}
